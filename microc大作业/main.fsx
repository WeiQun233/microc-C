...
#load "Absyn.fs"  "CPar.fs" "CLex.fs" "Debug.fs" "Parse.fs" "Machine.fs"  "Comp.fs" "ParseAndComp.fs";;   
...
#load "Absyn.fs"  "CPar.fs" "CLex.fs" "Debug.fs" "Parse.fs" "Machine.fs"  "ContComp.fs" "ParseAndContcomp.fs";;      
